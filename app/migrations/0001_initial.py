    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foto', models.ImageField(blank=True, default='https://tse2.mm.bing.net/th?id=OIP.Jw-MfZVo8aCZLEVTHvMZbQHaE8&pid=Api', null=True, upload_to='profile_pictures/')),
                ...
                ('preco', models.PositiveIntegerField(blank=True, default=0, null=True, verbose_name='Preço')),
                ('sexo', models.CharField(choices=[('Masculino', 'Masculino'), ('Feminino', 'Feminino'), ('Outro/Prefiro não indicar', 'Outro/Prefiro não indicar')], max_length=100)),
                ...
                ('limite_eventos', models.PositiveIntegerField(blank=True, default=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('num_occurrences', models.PositiveIntegerField(blank=True, null=True)),
